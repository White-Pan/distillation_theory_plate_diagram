...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButton_partial.setGeometry(QRect(110, 20, 98, 20))
        ...
        self.groupBox_output.setGeometry(QRect(20, 180, 411, 81))
        self.textBrowser_output = QTextBrowser(self.groupBox_output)
        self.textBrowser_output.setObjectName(u"textBrowser_output")
        self.textBrowser_output.setGeometry(QRect(10, 20, 391, 51))
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(260, 130, 158, 41))
        self.horizontalLayout_3 = QHBoxLayout(self.widget)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.pushButton_draw = QPushButton(self.widget)
        ...
        self.menubar.setGeometry(QRect(0, 0, 466, 33))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_output.setTitle(QCoreApplication.translate("MainWindow", u"\u8f93\u51fa\u7ed3\u679c", None))
